...
assert.ok(index.indexOf('js/encrypted-backup.js')<index.indexOf('js/backup-center.js'));assert.ok(index.indexOf('js/backup-center.js')<index.indexOf('js/encrypted-backup-ui.js'));assert.match(index,/accept="\.erpbackup,\.json,application\/json"/);assert.match(index,/css\/encrypted-backup\.css\?v=12\.0\.1/);
assert.match(workflow,/UI_SCREENSHOT_DIR: artifacts\/ui-v12\.0\.1/);assert.match(workflow,/path: artifacts\/ui-v12\.0\.1/);
