...
assert.match(index,/js\/permissions\.js\?v=11\.5\.2/);
assert.match(index,/js\/audit-history\.js\?v=11\.5\.2/);
assert.match(index,/css\/permissions\.css\?v=11\.5\.2/);
assert.match(index,/css\/audit-history\.css\?v=11\.5\.2/);
