...
assert.match(index,/js\/permissions\.js\?v=12\.0\.0/);
assert.match(index,/js\/audit-history\.js\?v=12\.0\.0/);
assert.match(index,/css\/permissions\.css\?v=12\.0\.0/);
assert.match(index,/css\/audit-history\.css\?v=12\.0\.0/);
