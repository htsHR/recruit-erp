...
const application=[
  'js/permissions.js','js/audit-history.js','js/encrypted-backup.js','js/core.js','js/applicants.js','js/tasks.js',
  'js/calendar.js','js/applicant-detail.js','js/applicant-tools.js','js/state-init.js','js/reports.js','js/app-bindings.js',
  'js/applicant-quick-entry.js','js/recruiter-daily-usability.js','js/local-only-init.js','js/app-ui.js','js/backup-center.js',
  'js/encrypted-backup-ui.js','js/applicant-bulk.js','js/applicant-progress-history.js','js/form-flow-stability.js',
  'js/screening-workbench.js','js/phone-interview.js','js/privacy-security.js','js/applicant-worksheet.js','js/ux-reboot-v12.js'
];
...
assert.equal(bodyScripts.length,26,'핵심업무판 본문 스크립트 수가 달라지면 로딩 계약을 다시 검토해야 합니다.');
...
console.log('initial-loading.test.js: 안전 선실행 5개·순서 보장 defer 26개 확인 완료');
