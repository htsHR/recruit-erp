...
const detail=read('js/detail-views.js');
const schoolRelations=read('js/school-relations.js');
const screening=read('js/screening-workbench.js');
const advanced=read('js/advanced-bulk.js');
...
assert.match(schoolRelations,/function schoolApplicantReferenceScore/,'학교 분석의 기존 참고 계산은 별도 범위로 보존해야 합니다.');
