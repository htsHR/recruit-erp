...
const fakePackage={
  format:'recruit-erp-backup',schemaVersion:2,appVersion:'11.0.0',statusSchemaVersion:2,backupType:'full',createdAt:'2026-08-02T00:00:00.000Z',
...
(async()=>{
  assert.equal(encrypted.VERSION,'11.0.0');assert.equal(encrypted.FORMAT,'recruit-erp-encrypted-backup');assert.equal(encrypted.CRYPTO_SCHEMA_VERSION,1);assert.equal(encrypted.DEFAULT_ITERATIONS,310000);
