...
(async()=>{
  assert.equal(appVersion.VERSION,'12.0.1');
  ...
  assert.match(index,/js\/app-version\.js\?v=12\.0\.1/);assert.match(index,/css\/production-readiness\.css\?v=12\.0\.1/);assert.match(index,/js\/production-readiness\.js\?v=12\.0\.1/);assert.match(permissions,/readiness\.manage/);
