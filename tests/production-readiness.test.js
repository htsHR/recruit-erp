...
(async()=>{
  ...
  assert.match(index,/css\/production-readiness\.css\?v=11\.2\.1/);assert.match(index,/js\/production-readiness\.js\?v=11\.2\.1/);assert.match(permissions,/readiness\.manage/);
