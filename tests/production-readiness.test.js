...
(async()=>{
  ...
  assert.match(index,/css\/production-readiness\.css\?v=11\.3\.0/);assert.match(index,/js\/production-readiness\.js\?v=11\.3\.0/);assert.match(permissions,/readiness\.manage/);
