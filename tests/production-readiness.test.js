...
assert.equal(readiness.VERSION,'12.4.0');
assert.equal(version.VERSION,'12.4.0');
assert.match(source,/UNCHANGED_ASSET_VERSIONS=new Set\(\['12\.0\.2','12\.0\.3','12\.1\.0','12\.2\.0','12\.2\.1','12\.2\.2','12\.3\.2'\]\)/);
