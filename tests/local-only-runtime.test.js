...
assert.equal(version.VERSION,'12.5.2');
...
for(const [name,source] of Object.entries({core,localInit,permissions}))assert.doesNotMatch(source,/supabase|127\.0\.0\.1:17840|\/storage\/snapshot|erpSharedStorage/i,`${name} 런타임에 폐기된 원격 연결이 남으면 안 됩니다.`);
