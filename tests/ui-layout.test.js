...
assert.match(index,/css\/applicant-worksheet\.css\?v=11\.3\.2/);assert.match(index,/js\/applicant-worksheet\.js\?v=11\.3\.2/);assert.match(index,/css\/ui-density-navigation\.css\?v=11\.3\.2/);
...
assert.match(index,/css\/applicant-quick-detail\.css\?v=11\.3\.2/);assert.match(applicants,/openApplicantQuickDetail/);assert.match(applicants,/moveApplicantQuickDetail/);assert.match(applicants,/행 클릭 → 빠른 보기/);
