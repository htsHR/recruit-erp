...
['btnRosterOrderEdit','btnCalendarRosterOrderEdit','rosterOrderEditor','rosterOrderEditorList','btnRosterOrderTimeSort','btnRosterOrderCancel','btnRosterOrderSave','btnRosterOrderSavePrint'].forEach(id=>assert.match(index,new RegExp(`id="${id}"`),`${id} 순서 편집 UI가 없습니다.`));
...
assert.match(reports,/function openRosterPrintFromOrderEditor\(\)/);assert.match(reports,/bind\('btnRosterOrderSavePrint','click',openRosterPrintFromOrderEditor\)/);
