...
assert.match(index,/<h1>Recruit ERP<\/h1>/);assert.match(index,/<p>v12\.1\.0<\/p>/);assert.doesNotMatch(index,/\bPreview\b|VERSION 2\.0|TODAY WORK OPERATIONS · ACTION FIRST/);assert.doesNotMatch(applicants,/QUICK REVIEW/);
