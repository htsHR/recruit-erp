...
const changedAssets=['css/components.css','js/app-version.js','js/production-readiness.js'];
...
localAssets.filter(([,file])=>!changedAssets.includes(file)).forEach(([,file,assetVersion])=>assert.ok(['12.0.2','12.0.3','12.1.0','12.2.0','12.2.1','12.2.2'].includes(assetVersion),`${file}의 변경 없는 캐시 버전을 불필요하게 올리면 안 됩니다.`));
