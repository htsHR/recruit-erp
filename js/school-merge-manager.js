...
function schoolMergeSafetyBackup(){
  ...
  const payload={format:'recruit-erp-backup',appVersion:'10.41.2',createdAt:new Date().toISOString(),reason:'중복 학교 통합 직전',applicants,schools,employees,calendarEvents};
