...
function schoolMergeSafetyBackup(){
  ...
  const payload={format:'recruit-erp-backup',appVersion:'10.40.27',createdAt:new Date().toISOString(),reason:'중복 학교 통합 직전',applicants,schools,employees,calendarEvents};
