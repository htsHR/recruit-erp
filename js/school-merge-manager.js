/* Recruit ERP v10.42.0 SCHOOL_MANAGEMENT_UI_UNIFICATION
...
function schoolMergeSafetyBackup(){
  ...
  const payload={format:'recruit-erp-backup',appVersion:'10.42.0',createdAt:new Date().toISOString(),reason:'중복 학교 통합 직전',applicants,schools,employees,calendarEvents};
