...
console.info('[HOME_DEV] Recruit ERP v11.0.0 loaded applicants:', applicants.length, 'hire waiting profiles:', hireWaitingProfiles.length, 'message templates:', messageTemplates.length);
