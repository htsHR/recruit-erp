/* Recruit ERP v10.63.0 storage capacity and IndexedDB safety mirror. */
(function(root,factory){
  ...
  function ensureUi(){
    ...
    if(main&&!root.document.getElementById('storagePerformance')){
      const section=root.document.createElement('section');section.className='page storage-performance-page';section.id='storagePerformance';section.dataset.requiredPermission='storage.manage';section.innerHTML='<div class="page-intro-card safety-intro-card"><div><h3>저장소·속도 관리</h3><p>대용량 데이터의 안전 복사 상태와 브라우저 저장공간을 개인정보 노출 없이 확인합니다.</p></div><span class="page-intro-badge">v10.63.0 STORAGE</span></div><div id="storagePerformanceBody"></div>';main.appendChild(section);
    }
  }
