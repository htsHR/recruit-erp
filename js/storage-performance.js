...
(function(root,factory){
  ...
  function loadSharedStorageScript(){
    ...
    const script=root.document.createElement('script');script.src='js/shared-storage.js?v=11.3.2';script.dataset.erpSharedStorage='true';script.addEventListener('load',()=>render());root.document.head.appendChild(script);
  }
